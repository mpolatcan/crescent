...
class Actions:
    class Read:
        ...
        def BatchCheckLayerAvailability(): return EcrAction(Actions.Read.BatchCheckLayerAvailability.__name__,
                                                            EcrAction.Repository.__name__)

        @staticmethod
        def BatchGetImage(): return EcrAction(Actions.Read.BatchGetImage.__name__, EcrAction.Repository.__name__)
        ...
        @staticmethod
        def DescribeImages(): return EcrAction(Actions.Read.DescribeImages.__name__, EcrAction.Repository.__name__)
    ...
    class Write:
        @staticmethod
        def BatchDeleteImage(): return EcrAction(Actions.Write.BatchDeleteImage.__name__, EcrAction.Repository.__name__)
        ...
        @staticmethod
        def CreateRepository(): return EcrAction(Actions.Write.CreateRepository.__name__, EcrAction.Repository.__name__)
        ...
        @staticmethod
        def DeleteRepository(): return EcrAction(Actions.Write.DeleteRepository.__name__, EcrAction.Repository.__name__)
        ...
        @staticmethod
        def PutImage(): return EcrAction(Actions.Write.PutImage.__name__, EcrAction.Repository.__name__)
        ...
        @staticmethod
        def StartImageScan(): return EcrAction(Actions.Write.StartImageScan.__name__, EcrAction.Repository.__name__)
        ...
        @staticmethod
        def UploadLayerPart(): return EcrAction(Actions.Write.UploadLayerPart.__name__, EcrAction.Repository.__name__)
    ...
    class List:
        ...
        @staticmethod
        def ListImages(): return EcrAction(Actions.List.ListImages.__name__, EcrAction.Repository.__name__)
    ...
    class Tagging:
        @staticmethod
        def TagResource(): return EcrAction(Actions.Tagging.TagResource.__name__, EcrAction.Repository.__name__)

        @staticmethod
        def UntagResource(): return EcrAction(Actions.Tagging.UntagResource.__name__, EcrAction.Repository.__name__)

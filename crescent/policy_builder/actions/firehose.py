...
class FirehoseAction(Action):
    ...
    def __init__(self, action_name, **definable_resources):
        super(FirehoseAction, self).__init__(self.__SERVICE_FIREHOSE, action_name, **definable_resources)
...
class FirehoseAccessLevelAllActions(AccessLevelAllActions):
    ...
    def DeliveryStream(self, delivery_stream: Union[str, DeliveryStreamArn]):
        return self._set_all_actions_resources(self.DeliveryStream.__name__, delivery_stream)
...
class Actions:
    class Write:
        ...
        def CreateDeliveryStream(): return FirehoseAction(Actions.Write.CreateDeliveryStream.__name__,
                                                          required=[FirehoseAction.DeliveryStream.__name__])

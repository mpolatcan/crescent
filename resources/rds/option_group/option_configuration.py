...
class OptionConfiguration(BaseModel):
    ...
    def db_security_group_memberships(self, value: List[str]):
        return self._add_field(self.__PROPERTY_DB_SECURITY_GROUP_MEMBERSHIPS, value)

    def option_name(self, value: str):
        return self._add_field(self.__PROPERTY_OPTION_NAME, value)

    def option_settings(self, value: List[OptionSetting]):
        return self._add_field(self.__PROPERTY_OPTION_SETTINGS, [
            option_setting.create() for option_setting in value
        ])
    ...
    def vpc_security_group_memberships(self, value: List[str]):
        return self._add_field(self.__PROPERTY_VPC_SECURITY_GROUP_MEMBERSHIPS, value)
